      ...
      <div className="max-w-4xl mx-auto w-full">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className={`transition-all duration-700 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            backdropFilter: 'blur(12px)'
              ...
              {/* Email */}
              <div className="mb-8">
                <a href="mailto:hello@johndeveloper.com" className="inline-flex items-center text-lg font-medium text-autumn-leaf hover:text-autumn-amber transition-colors">kushagrakinra@gmail.com<Mail className="w-5 h-5 mr-3" />
          ...
          <div className={`transition-all duration-700 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            backdropFilter: 'blur(12px)'
              ...
              <div>
                ...
                <Input id="name" placeholder="Your name" className="bg-white/50 border-autumn-warmth focus:border-autumn-leaf focus:ring-autumn-leaf/20" />
              </div>
              ...
              <div>
                ...
                <Input id="email" type="email" placeholder="your@email.com" className="bg-white/50 border-autumn-warmth focus:border-autumn-leaf focus:ring-autumn-leaf/20" />
              </div>
              ...
              <div>
                ...
                <Textarea id="message" placeholder="Tell me about your project..." rows={5} className="bg-white/50 border-autumn-warmth focus:border-autumn-leaf focus:ring-autumn-leaf/20 resize-none" />
              </div>

              <Button type="submit" className="w-full bg-autumn-leaf hover:bg-autumn-amber text-white py-6 text-lg font-medium rounded-xl transition-all duration-300 hover:scale-[1.02]">
        ...
        <div className={`text-center mt-20 transition-all duration-700 delay-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
          <p className="text-autumn-bark/60">
            © {new Date().getFullYear()} John Developer. Built with passion and creativity.
          </p>
        </div>
      </div>
    </section>;
