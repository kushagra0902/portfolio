...
const ContactSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-screen py-24 lg:py-32 px-6 flex items-center"
    >
      <div className="max-w-4xl mx-auto w-full">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-autumn-bark/70 max-w-2xl mx-auto">
            Ready to start a new project or just want to say hello? I'd love to
            hear from you.
          </p>
        </div>
          ...
          >
            ...
            >
              ...
              <p className="text-autumn-bark/70 mb-8 leading-relaxed">
                ...
                connect — my inbox is always open. Let's create something
                amazing together.
              </p>
              ...
              <div className="mb-8">
                <a
                  ...
                  className="inline-flex items-center text-lg font-medium text-autumn-leaf hover:text-autumn-amber transition-colors"
                >
                ...
                {socialLinks.map((social) => {
                  ...
                  return (
                    <a
                      ...
                      className="w-12 h-12 rounded-full bg-autumn-warmth flex items-center justify-center text-autumn-bark hover:bg-autumn-leaf hover:text-white transition-all duration-300 hover:scale-110"
                    >
          ...
          >
            ...
            >
              <div>
                <label
                  htmlFor="name"
                  className="block text-sm font-medium text-autumn-bark mb-2"
                >
                  Name
                </label>
                <Input
        ...
        {/* Footer */}
        <div
          className={`text-center mt-20 transition-all duration-700 delay-700 ${isVisible ? "opacity-100" : "opacity-0"}`}
        >
          <p className="text-autumn-bark/60">
            © {new Date().getFullYear()} Kushagra Kinra. Built with passion and
            creativity.
          </p>
        </div>
      </div>
